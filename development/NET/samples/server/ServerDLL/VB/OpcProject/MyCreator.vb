...
#Region "Public Methods"
		...
		Public Overloads Overrides Function CreateInternalAeAddressSpaceElement(ByVal aName As String, ByVal anUserData As System.UInt32, ByVal anObjectHandle As UInt32, ByVal aParentHandle As UInt32) As AeAddressSpaceElement
