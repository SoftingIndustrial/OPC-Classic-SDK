    ...
    Public Class OpcForm
        ...
        Public Sub New(ByVal anOutProc As OutProc)
            ...
            Try
                ...
                If ResultCode.SUCCEEDED(rootDaAddressSpaceElement.Browse(browseOptions, addressSpaceElements, m_executionOptions)) Then
            ...
            Try
                ...
                For Each node As TreeNode In e.Node.Nodes
                    ...
                    If TypeOf node.Tag Is DaAddressSpaceElement Then
                        ...
                        If ResultCode.SUCCEEDED(element.Browse(browseOptions, addressSpaceElements, m_executionOptions)) Then
                            If Not addressSpaceElements Is Nothing Then
                                Dim i As Integer = 0
                                While i < addressSpaceElements.Length
