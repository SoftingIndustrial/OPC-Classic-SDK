...
// Attributes
public:
	virtual void SetText(int /* nRow */, int /* nCol */, LPCTSTR szText)
	{
		m_strText = szText;
	}
	virtual void SetImage(int /* nRow */, int /* nCol */, int nImage)
	{
		m_nImage = nImage;
	}
	virtual void SetData(int /* nRow */, int /* nCol */, LPARAM lParam)
	{
		m_lParam = lParam;
	}
	...
	virtual void SetTextClr(int /* nRow */, int /* nCol */, COLORREF clr)
	{
		m_crFgClr = clr;
	}
	virtual void SetBackClr(int /* nRow */, int /* nCol */, COLORREF clr)
	{
		m_crBkClr = clr;
	}
	...
	virtual void SetMargin(int /* nRow */, int /* nCol */, UINT nMargin)
	{
		m_nMargin = nMargin;
	}
	...
	virtual int      GetImage(int /* nRow */, int /* nCol */) const
	{
		return m_nImage;
	}
	virtual LPARAM   GetData(int /* nRow */, int /* nCol */) const
	{
		return m_lParam;
	}
	virtual DWORD    GetFormat(int /* nRow */, int /* nCol */) const
	{
		return m_nFormat;
	}
	virtual COLORREF GetTextClr(int /* nRow */, int /* nCol */) const
	{
		return m_crFgClr;
	}
	virtual COLORREF GetBackClr(int /* nRow */, int /* nCol */) const
	{
		return m_crBkClr;
	}
	...
	virtual UINT     GetMargin(int /* nRow */, int /* nCol */) const
	{
		return m_nMargin;
	}
