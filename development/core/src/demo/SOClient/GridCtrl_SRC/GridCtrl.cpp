...
//***>>SJ 25.08.2005
//	Rechanged AfxGetResourceHandle() to AfxGetInstanceHandle() in RegisterWindowClass,
//  as it was implemented previously. See changes of Cris Maunder in 13 Mar 2004 (V2.25).
//  To register the WindowClass over AfxGetResourceHandle() causes problems
//	by applications with different language (resource) DLLs!
//***<<
...
BOOL CGridCtrl::RegisterWindowClass()
{
	WNDCLASS wndcls;
//***>> SJ 25.08.2005
//	Rechanged AfxGetResourceHandle() to AfxGetInstanceHandle(), as it was implemented previously!
//  To register the WindowClass over AfxGetResourceHandle() causes problems
//	by applications with different language (resource) DLLs!
