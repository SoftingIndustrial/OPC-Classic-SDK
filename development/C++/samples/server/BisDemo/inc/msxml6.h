...
#define IXMLDOMDocument3_importNode(This,node,deep,clone)   \
	...
	/* [helpstring][id] */
	HRESULT STDMETHODCALLTYPE IXMLDOMDocument3_importNode_Proxy(
		IXMLDOMDocument3* This,
		/* [in] */ IXMLDOMNode* node,
		/* [in] */ VARIANT_BOOL deep,
		/* [retval][out] */ IXMLDOMNode** clone);
...
#define IXMLDOMParseError2_get_errorParametersCount(This,count) \
	...
	/* [id][propget] */
	HRESULT STDMETHODCALLTYPE IXMLDOMParseError2_get_allErrors_Proxy(
		IXMLDOMParseError2* This,
		/* [retval][out] */ IXMLDOMParseErrorCollection** allErrors);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IXMLDOMParseError2_errorParameters_Proxy(
		IXMLDOMParseError2* This,
		/* [in] */ long index,
		/* [retval][out] */ BSTR* param);
	...
	/* [id][propget] */
	HRESULT STDMETHODCALLTYPE IXMLDOMParseError2_get_errorParametersCount_Proxy(
		IXMLDOMParseError2* This,
		/* [retval][out] */ long* count);
...
#define IXMLDOMParseErrorCollection_get__newEnum(This,ppunk)    \
	...
	/* [propget][id] */
	HRESULT STDMETHODCALLTYPE IXMLDOMParseErrorCollection_get_length_Proxy(
		IXMLDOMParseErrorCollection* This,
		/* [retval][out] */ long* length);
	...
	/* [propget][id] */
	HRESULT STDMETHODCALLTYPE IXMLDOMParseErrorCollection_get_next_Proxy(
		IXMLDOMParseErrorCollection* This,
		/* [retval][out] */ IXMLDOMParseError2** error);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IXMLDOMParseErrorCollection_reset_Proxy(
		IXMLDOMParseErrorCollection* This);
	...
	/* [propget][restricted][hidden][id] */
	HRESULT STDMETHODCALLTYPE IXMLDOMParseErrorCollection_get__newEnum_Proxy(
		IXMLDOMParseErrorCollection* This,
		/* [retval][out] */ IUnknown** ppunk);
...
#define IMXXMLFilter_putref_errorHandler(This,oHandler) \
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IMXXMLFilter_putFeature_Proxy(
		IMXXMLFilter* This,
		/* [in] */ BSTR strName,
		/* [in] */ VARIANT_BOOL fValue);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IMXXMLFilter_getProperty_Proxy(
		IMXXMLFilter* This,
		/* [in] */ BSTR strName,
		/* [retval][out] */ VARIANT* varValue);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IMXXMLFilter_putProperty_Proxy(
		IMXXMLFilter* This,
		/* [in] */ BSTR strName,
		/* [in] */ VARIANT varValue);
	...
	/* [propget][id] */
	HRESULT STDMETHODCALLTYPE IMXXMLFilter_get_entityResolver_Proxy(
		IMXXMLFilter* This,
		/* [retval][out] */ IUnknown** oResolver);
	...
	/* [propputref][id] */
	HRESULT STDMETHODCALLTYPE IMXXMLFilter_putref_entityResolver_Proxy(
		IMXXMLFilter* This,
		/* [in] */ IUnknown* oResolver);
	...
	/* [propget][id] */
	HRESULT STDMETHODCALLTYPE IMXXMLFilter_get_contentHandler_Proxy(
		IMXXMLFilter* This,
		/* [retval][out] */ IUnknown** oHandler);
	...
	/* [propputref][id] */
	HRESULT STDMETHODCALLTYPE IMXXMLFilter_putref_contentHandler_Proxy(
		IMXXMLFilter* This,
		/* [in] */ IUnknown* oHandler);
	...
	/* [propget][id] */
	HRESULT STDMETHODCALLTYPE IMXXMLFilter_get_dtdHandler_Proxy(
		IMXXMLFilter* This,
		/* [retval][out] */ IUnknown** oHandler);
	...
	/* [propputref][id] */
	HRESULT STDMETHODCALLTYPE IMXXMLFilter_putref_dtdHandler_Proxy(
		IMXXMLFilter* This,
		/* [in] */ IUnknown* oHandler);
	...
	/* [propget][id] */
	HRESULT STDMETHODCALLTYPE IMXXMLFilter_get_errorHandler_Proxy(
		IMXXMLFilter* This,
		/* [retval][out] */ IUnknown** oHandler);
	...
	/* [propputref][id] */
	HRESULT STDMETHODCALLTYPE IMXXMLFilter_putref_errorHandler_Proxy(
		IMXXMLFilter* This,
		/* [in] */ IUnknown* oHandler);
...
IXMLDOMSchemaCollection2 :
	public IXMLDOMSchemaCollection
	{
public:
...
#define IServerXMLHTTPRequest2_setProxyCredentials(This,bstrUserName,bstrPassword)  \
	...
	/* [helpstring][id] */
	HRESULT STDMETHODCALLTYPE IServerXMLHTTPRequest2_setProxyCredentials_Proxy(
		IServerXMLHTTPRequest2* This,
		/* [in] */ BSTR bstrUserName,
		/* [in] */ BSTR bstrPassword);
...
#define IMXNamespacePrefixes_get__newEnum(This,ppUnk)   \
	...
	/* [id][propget] */
	HRESULT STDMETHODCALLTYPE IMXNamespacePrefixes_get_length_Proxy(
		IMXNamespacePrefixes* This,
		/* [retval][out] */ long* length);
	...
	/* [id][hidden][restricted][propget] */
	HRESULT STDMETHODCALLTYPE IMXNamespacePrefixes_get__newEnum_Proxy(
		IMXNamespacePrefixes* This,
		/* [retval][out] */ IUnknown** ppUnk);
...
#define IVBMXNamespaceManager_getURIFromNode(This,strPrefix,contextNode,uri)    \
	...
	/* [id][propget] */
	HRESULT STDMETHODCALLTYPE IVBMXNamespaceManager_get_allowOverride_Proxy(
		IVBMXNamespaceManager* This,
		/* [retval][out] */ VARIANT_BOOL* fOverride);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IVBMXNamespaceManager_reset_Proxy(
		IVBMXNamespaceManager* This);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IVBMXNamespaceManager_pushContext_Proxy(
		IVBMXNamespaceManager* This);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IVBMXNamespaceManager_pushNodeContext_Proxy(
		IVBMXNamespaceManager* This,
		/* [in] */ IXMLDOMNode* contextNode,
		/* [defaultvalue][in] */ VARIANT_BOOL fDeep);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IVBMXNamespaceManager_popContext_Proxy(
		IVBMXNamespaceManager* This);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IVBMXNamespaceManager_declarePrefix_Proxy(
		IVBMXNamespaceManager* This,
		/* [in] */ BSTR prefix,
		/* [in] */ BSTR namespaceURI);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IVBMXNamespaceManager_getDeclaredPrefixes_Proxy(
		IVBMXNamespaceManager* This,
		/* [retval][out] */ IMXNamespacePrefixes** prefixes);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IVBMXNamespaceManager_getPrefixes_Proxy(
		IVBMXNamespaceManager* This,
		/* [in] */ BSTR namespaceURI,
		/* [retval][out] */ IMXNamespacePrefixes** prefixes);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IVBMXNamespaceManager_getURI_Proxy(
		IVBMXNamespaceManager* This,
		/* [in] */ BSTR prefix,
		/* [retval][out] */ VARIANT* uri);
	...
	/* [id] */
	HRESULT STDMETHODCALLTYPE IVBMXNamespaceManager_getURIFromNode_Proxy(
		IVBMXNamespaceManager* This,
		/* [in] */ BSTR strPrefix,
		/* [in] */ IXMLDOMNode* contextNode,
		/* [retval][out] */ VARIANT* uri);
