...
extern const TCHAR g_folderFullPath[256];
extern const TCHAR g_folderName[256];
extern const TCHAR g_folderNameFormat[16];
extern const unsigned int g_foldersCount;
