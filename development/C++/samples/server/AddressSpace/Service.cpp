...
const tstring g_serviceDescription = _T("Softing OPC Toolkit - OPC DA Server. \r\n\r\nSample name: \"C++ AddressSpace_Service\".");
	...
	int cmdShow)
{
	...
	pServer->initialize();
	// set the service name and description to the OpcServer instance
	pServer->setServiceName(g_serviceName);
	pServer->setServiceDescription(g_serviceDescription);
